...
# Example usage
csv_file_path <- "D:/UNISR/Thesis/Systematic review/articles.csv"  # Corrected path
output_folder <- "D:/UNISR/Thesis/Systematic review/Downloaded_Articles"  # Corrected path
